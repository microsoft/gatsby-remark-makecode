...
const hash = req => crypto.createHash("md5").update(JSON.stringify(req) + versions).digest("hex");
...
exports.render = req => {
  ...
  if (fs.existsSync(fs)) req = JSON.parse(JSON.stringify(req));
        ...
        case "renderready":
          {
            ...
            versions = JSON.stringify(msg.versions);
            pendingRequests = {};
            resolve();
            break;
          }
        ...
        case "renderblocks":
          {
            ...
            console.info(`mkcd: rendered`, msg.id); // render to file 
